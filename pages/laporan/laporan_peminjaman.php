...
$TAMPIL = user_tampil("SELECT * FROM tb_peminjaman ORDER BY tb_peminjaman.id_peminjaman ASC");
...
?>   
                             ...
                             <tfoot>
                                ...
                                <div class="hidden-print col-md-12 text-right">
                                    ...
                                    <a href="index.php?pages=peminjaman&aksi=tampil" class="btn btn-info btn-round">Cancel</a>
                                </div>
                            </div>
                        </div>
                    </div>
