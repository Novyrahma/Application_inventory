...
$TAMPIL = user_tampil("SELECT  tb_pengajuan.*,tb_databarang.*,tb_kategori.* FROM tb_pengajuan
JOIN tb_databarang ON tb_databarang.id_barang=tb_pengajuan.id_barang
JOIN tb_kategori ON tb_pengajuan.id_kategori=tb_kategori.id_kategori
ORDER BY tb_pengajuan.id_pengajuan ");
...
?>   
                             ...
                             <tr>
                                ...
                                <div class="hidden-print col-md-12 text-right">
                                    ...
                                    <a href="index.php?pages=pengajuan&aksi=tampil" class="btn btn-info btn-round">Cancel</a>
                                </div>
                            </div>
                        </div>
                    </div>
