...
$TAMPIL = user_tampil  ("SELECT  tb_pengaduan_kondisi.*,tb_databarang.*,tb_kategori.*,tb_siswa.* FROM tb_pengaduan_kondisi
JOIN tb_databarang ON tb_pengaduan_kondisi.id_barang=tb_databarang.id_barang
JOIN tb_kategori ON tb_pengaduan_kondisi.id_kategori=tb_kategori.id_kategori
JOIN tb_siswa ON tb_pengaduan_kondisi.nis=tb_siswa.nis
ORDER BY tb_pengaduan_kondisi.id_pengaduan ");
                                ...
                                <tr>
                                  ...
                                  <td><?= $DATA['keterangan']; ?></td>
                                    ...
                                    <td><?= $DATA['id_ruangan']; ?></td>
                                     <td><?= $DATA['foto_sebelum']; ?></td>
                                     <td><?= $DATA['foto_sesudah']; ?></td>
                                     <td><?= $DATA['nis']; ?></td>
...
?>   
                             ...
                             <tfoot>
                                ...
                                <div class="hidden-print col-md-12 text-right">
                                    ...
                                    <a href="index.php?pages=pengaduan&aksi=tampil" class="btn btn-info btn-round">Cancel</a>
                                </div>
                            </div>
                        </div>
                    </div>
