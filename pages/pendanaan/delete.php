...
$id=$_GET['kode_dana'];
$query = mysqli_query($kon, "SELECT * FROM tb_pendanaan WHERE kode_dana = '$id'") or die(mysql_error());
    ...
    <div class="section">
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                <h3>Apakah anda menghapus data Kategori : <?php echo $data['sumber_dana']; ?></h3>
                  <form class="form-horizontal col-sm-12" method="post" role="form">
                    <div class="form-group">
                    <hr>
                     <div class="">
                        <a href="index.php?pages=pendanaan&aksi=proses_delete&kode_dana=<?php echo $data ['kode_dana'];?>" class="btn btn-danger">
                <span class="glyphicon glyphicon-ok" aria-hidden="true"></span> hapus</a>
                        <a href="?pages=pendanaan" class="btn btn-info">
