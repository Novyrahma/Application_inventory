...
$id=$_GET['id_kategori'];
$sql= "SELECT * FROM tb_kategori WHERE id_kategori = '$id' " or die ("Gagal Melakukan Query!!". mysqli_error());
...
?>
                    <div class="body">
                         <form role="form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">                                
                                <input name="Nama_kategori" type="text" id="nama_kategori" class="form-control" value="<?php echo $nama; ?>">
                            </div>
